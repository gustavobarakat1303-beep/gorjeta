---
name: conciliacao-nomade
description: Conciliação mensal de despesas do Nomade cruzando Everest (notas recebidas), planilha Excel de controle e fatura do cartão. Gera o diagnóstico completo (4 direções: o que falta no Excel, o que falta no Everest, cartão sem Excel, cartão sem Everest) em uma planilha .xlsx + resumo administrativo.
---

# Conciliação de despesas — Nomade
